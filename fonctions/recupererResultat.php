<?php
    ...
    $resultats = $mysqliObject->prepare('SELECT idTrajet, Kilometrage, dateDepart, dateRetour, dureeEnHeures, idMeteo, idTypeTrafic, idsTypesRoutes, idsManoeuvres, actifTrajet FROM Trajets');
    ...
    $nomMeteo = $mysqliObject->prepare('SELECT idMeteo, nomMeteo, imgMeteo, actifMeteo FROM Meteo');
    ...
    $nomManoeuvres = $mysqliObject->prepare('SELECT idManoeuvre, nomManoeuvre, imgManoeuvre, actifManoeuvre FROM Manoeuvres');
    ...
    $nomTypeRoute = $mysqliObject->prepare('SELECT idTypeRoute, nomTypeRoute, imgTypeRoute, actifTypeRoute FROM TypeRoute');
    ...
    $nomTypeTrafic = $mysqliObject->prepare('SELECT idTypeTrafic, nomTypeTrafic, imgTrafic, actifTypeTrafic FROM TypeTrafic');
